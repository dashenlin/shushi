...
<table width="100%"  class="table_form">
  ...
  <tr><th width="120"><?php echo L('setting_web_phone')?></th><td class="y-bg"><input type="text" class="input-text" name="setconfig[web_phone]" id="web_phone" size="30" value="<?php echo WEB_PHONE ?>"/></td></tr>
  <tr><th width="120"><?php echo L('setting_web_address')?></th><td class="y-bg"><input type="text" class="input-text" name="setconfig[web_address]" id="web_address" size="30" value="<?php echo WEB_ADDRESS ?>"/></td></tr>
  <tr><th width="120"><?php echo L('setting_web_icp')?></th><td class="y-bg"><input type="text" class="input-text" name="setconfig[web_icp]" id="web_icp" size="30" value="<?php echo WEB_ICP ?>"/></td></tr>
  <tr>
